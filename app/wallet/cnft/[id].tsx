...
import { MOCK_BATCHES, MOCK_WALLET } from '@/mocks';
...
export default function AssetDetailRoute() {
  ...
  const asset = MOCK_WALLET.cnfts.find((item) => item.id === id);
  const batch = MOCK_BATCHES.find((item) => item.id === asset?.batchId);
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.detailCard, { backgroundColor: c.surface, borderColor: c.border }]}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={[styles.detailValue, { color: c.foreground }]}>{MOCK_WALLET.address}</Text>
          </View>
          <View style={styles.detailRow}>
